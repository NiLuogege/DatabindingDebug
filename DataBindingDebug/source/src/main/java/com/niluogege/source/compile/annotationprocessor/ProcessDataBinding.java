...
package com.niluogege.source.compile.annotationprocessor;
...
import com.niluogege.source.compile.annotationprocessor.BindableBag;
...
public class ProcessDataBinding extends AbstractProcessor {
    ...
    private void initProcessingSteps(ProcessingEnvironment processingEnv) {
        ...
        Callback dataBinderWriterCallback = new Callback() {
            ...
            com.niluogege.source.compile.annotationprocessor.BindableBag.BRMapping mBRVariableLookup;
            ...
            @Override
            public void onBrWriterReady(com.niluogege.source.compile.annotationprocessor.BindableBag.BRMapping brWithValues, List<String> brPackages) {
